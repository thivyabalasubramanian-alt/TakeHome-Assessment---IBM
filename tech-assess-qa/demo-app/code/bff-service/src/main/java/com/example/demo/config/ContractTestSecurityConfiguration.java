 ...
 * {@link JwtAuthenticationToken} so downstream code that reads the JWT (e.g. service
 * account token forwarding) can function without a real Keycloak instance.
 *
 * <p>Accepts the static Bearer token {@code test-token-for-validation} as well as
